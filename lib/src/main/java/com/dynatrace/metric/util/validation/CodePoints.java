...
public final class CodePoints {
	...
	public static final int COLON = ":".codePointAt(0);
	...
	public static final int DOT = ".".codePointAt(0);
	public static final int HYPHEN = "-".codePointAt(0);
	public static final int UNDERSCORE = "_".codePointAt(0);
	public static final int NUMBER_SIGN = "#".codePointAt(0);
	public static final int CURLY_BRACKET_OPEN = "{".codePointAt(0);
	public static final int CURLY_BRACKET_CLOSE = "}".codePointAt(0);
