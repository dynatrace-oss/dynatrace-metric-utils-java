...
public class NormalizerTest {
  ...
  void testMetadataNormalization(String name, String input, String expected) {
    assertEquals(expected, Normalizer.normalizeMetadataString(input, MAX_TEST_STRING_LENGTH).getResult());
  }
  ...
  public static Stream<Arguments> provideMetadataValues() {
    return Stream.of(
      ...
      // these tests might fail depending on the java version used for building, because older versions of Java might
      ...
      // this test might fail if the Unicode character U+1FACC gets a symbol assigned, and the java version is
      // sufficiently new to include the new symbol.
      Arguments.of("invalid unassigned unicode outside the Supplemental range", "\uD83E\uDECC", null),
      // multiple codepoints are combined into one emoji, in this case two people and two kids are a family emoji
      Arguments.of("valid unicode with multiple codepoints",
        "\uD83D\uDC68\u200D\uD83D\uDC69\u200D\uD83D\uDC67\u200D\uD83D\uDC67",
        "\uD83D\uDC68\u200D\uD83D\uDC69\u200D\uD83D\uDC67\u200D\uD83D\uDC67"),
      ...
      // we have a '\n' at the 255th pos. Escaping it will cause going overboard - 256. It should not
      // append it
      Arguments.of(
        "invalid truncate value with invalid char at last position",
